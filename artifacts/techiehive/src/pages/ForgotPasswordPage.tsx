    ...
    <div style={{ backgroundColor: "var(--th-bg)", minHeight: "100vh", color: "var(--th-text)" }}>
      ...
      <div style={{ maxWidth: "480px", margin: "0 auto", padding: "80px 24px 96px" }}>
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <p style={{ color: "var(--th-muted)", fontSize: "0.9rem", lineHeight: 1.6 }}>
          ...
          {submitted ? (
            <div style={{ textAlign: "center", padding: "8px 0" }}>
              ...
              <p style={{ color: "var(--th-muted)", fontSize: "0.875rem", lineHeight: 1.7, margin: "0 0 24px" }}>
                If an account exists with <strong style={{ color: "var(--th-text-sec)" }}>{email}</strong>, a password reset link has been sent. Check your spam folder if you don't see it.
              </p>
